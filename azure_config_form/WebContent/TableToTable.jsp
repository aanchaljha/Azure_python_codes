	...
	<div class="s">
		...
		<div class="mui-tabs__pane mui--is-active" id="pane-justified-2">
			<div class="mui-container">
				...
				<form action="TableToTable" method="post" class="mui-form">
					<br> <br>

					

					<%
						ArrayList<String> arrayList = (ArrayList) session.getAttribute("listTables");
					...
					<div class="mui-dropdown">
						<button class="mui-btn mui-btn--primary"
							...
							Source Table <span class="mui-caret"></span>
						</button>
						</div>
						<div class="mui-dropdown">
						
							<select name="table" id="table" class="mui-btn mui-btn--primary"
								data-mui-toggle="dropdown">
								<option>Target Table</option>
								<%
